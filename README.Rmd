...
The function incidencePrevalenceReport takes a character string for title, author and other variables. 
...
To launch the Shiny app use resultsDashboard(). It automatically takes as an input the mock data, or the folders where the data is located. 
