...
test_that("reset data", {
  testServer(reportGenerator(logger), {
    ...
    expect_equal(uploadedFiles$IncidencePrevalence, NULL)
    expect_equal(uploadedFiles$TreatmentPatterns, NULL)
    expect_equal(uploadedFiles$CohortCharacteristics, NULL)
