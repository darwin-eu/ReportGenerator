...
# incUI <- function(id, uploadedFiles) {
#   ns <- NS(id)
...
#   analysisInterval <- unique(uploadedFiles$IncidencePrevalence$incidence_estimates$analysis_interval)
...
#   denominatorTargetCohortName <- unique(uploadedFiles$IncidencePrevalence$incidence_estimates$denominator_target_cohort_name)
#   analysisRepeatedEvents <- unique(uploadedFiles$IncidencePrevalence$incidence_estimates$analysis_repeated_events)
...
# }
#
# incServer <- function(id, uploadedFiles) {
#
